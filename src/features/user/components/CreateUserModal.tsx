...
import { createGenderOptions } from "../types/Gender";
import { MultiValue } from "react-select";
import Select from "react-select";
import PasswordInput from "@/components/PasswordInput";
import { Mail, Phone } from "lucide-react";
import { ChangeEvent, useRef, useState } from "react";
import DefaultUser, { PermissionModel, RoleModel, User } from "../types/IUser";
...
import Input from "@features/user/components/UserInput";
import { genderSelectStyles } from "../styles/genderSelectStyles";
import { permissionSelectStyles, roleSelectStyles } from "../styles/selectStyle";
import { createUserSchema, createUserSchemaType } from "../validation/userSchema";
