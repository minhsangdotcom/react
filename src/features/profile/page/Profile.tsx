      ...
      <div className="w-full px-4 pb-10 sm:px-0 sm:max-w-md md:max-w-lg 2xl:max-w-2xl mt-3 mx-auto">
        ...
        <form className="w-full" onSubmit={handleSubmit(submit)}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="flex flex-col">
              <label className="block mb-2 text-sm font-medium text-gray-700">
                {t(TRANSLATION_KEYS.profile.form.fields.firstName)}
              </label>
              <input
                {...register("firstName")}
            ...
            <div className="flex flex-col">
              <label className="block mb-2 text-sm font-medium text-gray-700">
                {t(TRANSLATION_KEYS.profile.form.fields.lastName)}
              </label>
              <input
                {...register("lastName")}
                className={`w-full px-4 py-3 text-base border rounded-lg transition-colors focus:outline-none ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="flex flex-col">
              <label className="block mb-2 text-sm font-medium text-gray-700">
                {t(TRANSLATION_KEYS.profile.form.fields.email)}
              </label>
              <input
                type="email"
                {...register("email")}
            ...
            <div className="flex flex-col">
              <label className="block mb-2 text-sm font-medium text-gray-700">
                {t(TRANSLATION_KEYS.profile.form.fields.phoneNumber)}
              </label>
              <input
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="flex flex-col input-wrapper">
              <label className="block mb-2 text-sm font-medium text-gray-700">
                {t(TRANSLATION_KEYS.profile.form.fields.dateOfBirth)}
              </label>
              <Controller
                name="dateOfBirth"
                control={control}
            ...
            <div className="flex flex-col">
              <label className="block mb-2 text-sm font-medium text-gray-700">
                {t(TRANSLATION_KEYS.profile.form.fields.gender)}
              </label>
              <Controller
                name="gender"
                control={control}
